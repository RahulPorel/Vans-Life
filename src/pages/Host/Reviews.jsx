...
import "./Host Styles/HostReviews.css";
    ...
    return (
      <div className="review" key={review.id}>
        ...
        <div className="review-author">
          ...
          <p className="review-author-date">{review.date}</p>
        </div>
      ...
      <div className="reviews-overall">
        ...
        <div className="rating-overview">
          <div className="rating-row">
            ...
            <div className="rating-line rating-5"></div>
            <p>100%</p>
          </div>
          <div className="rating-row">
            <p className="rating-text">4 stars</p>
            <div className="rating-line"></div>
            <p>0%</p>
          </div>
          <div className="rating-row">
            <p className="rating-text">3 stars</p>
            <div className="rating-line"></div>
            <p>0%</p>
          </div>
          <div className="rating-row">
            <p className="rating-text">2 stars</p>
            <div className="rating-line"></div>
            <p>0%</p>
          </div>
          <div className="rating-row">
